...
namespace IS_Team1_Project
{
    public partial class AdminCourses : Form
    {
        ...
        private string connectionstring = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + frmLogin.dbPath;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@lecturer_email", txtLecturerEmail);
            cmd.Parameters.AddWithValue("@lecturer_number", txtLecturerNumber);
